	...
	<body>
		...
		<div id="dash-main">
			...
			<div class="dash-narrow-content">
			    ...
			    <a href="new_subcategory.php"><h6 class="btn btn-primary animate-box">Create New Subcategory </h6></a>
				<a href="view_delete_subcategory.php"><h6 class="btn btn-primary animate-box">Delete Subcategory </h6></a>
				<a href="view_edit_subcategory.php"><h6 class="btn btn-primary animate-box">Edit Subcategory </h6></a>
			</div>
           ...
           <!-- card area -->
            ...
            ?>
                ...
                <div class="row g-0">
                    <div class="col-md-4">
                    <img style="height:200px; " src="images-db/item/<?php echo $image;?>"  class="img-fluid rounded-start" alt="...">
					...
					<a href="edit_subcategory.php?itemId=<?php echo $id;?>&image=<?php echo $image;?>" class="btn btn-primary ">Edit</a>					
					<button onclick="document.getElementById('id01').style.display='block'" class="btn btn-primary " >Delete</button>
					</div>
