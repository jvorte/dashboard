         ...
         <?php 
            ...
            if (isset($_GET['itemId']))
             {
                ...
                $sql = "SELECT * FROM item WHERE itemGroup=$id";    
            ...
            ?>
                ...
                <div class="row g-0">
                    ...
                    <img style="height:200px; width:200px"  src="images-db/item/<?php echo $image;?>"  class="img-fluid rounded-start" alt="...">
					<div class="act-feat-item">
						<h6>Active:<?php echo $active;?></h6>
						<h6>Featured:<?php echo $featured;?></h6>
					</div>

					<div class="btn-group" role="group" aria-label="">
					<a href="edit_subcategory.php?itemId=<?php echo $id;?>&image=<?php echo $image;?>" class="btn btn-primary animate-box">Edit</a>					
					<button onclick="document.getElementById('id01').style.display='block'" class="btn btn-primary animate-box" >Delete</button>
					</div>
					...
					<textarea readonly class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 140px;padding-top:10px;" ><?php echo $info;?></textarea>
				
					</div>
					<div class="form-floating">
					<textarea readonly class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 170px ; margin-top:10px;"><?php echo $info;?></textarea>
				...
				<div id="id01" class="modal">
					...
					<form class="modal-content" action="/action_page.php">
						...
						<div class="clearfix">
							...
							<a href="delete_subcategory.php?itemId=<?php echo $id;?>&image=<?php echo $image;?>" class="btn btn-warning">Delete</a>
