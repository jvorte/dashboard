	...
	<body>
		...
		<div id="dash-main">
			...
			<div class="dash-narrow-content">
				...
				<div class="group-btn">	
			    <a href="new_category.php"><h6 class="btn btn-primary animate-box">Create New Category </h6></a>
				<a href="view_delete_category.php"><h6 class="btn btn-primary animate-box">Delete Category </h6></a>
				<a href="view_edit_category.php"><h6 class="btn btn-primary animate-box">Edit Category </h6></a>
			    </div>
				...
				<div class="card  animate-box" id="categ-card">
					...
					<div class="card-body">
						...
						<a href="view_items.php?itemId=<?php echo $id;?>" class="btn btn-primary">Category Items</a>
						<a href="new_categ_subcategory.php?itemId=<?php echo $id;?>" class="btn btn-primary">Add Items</a>
