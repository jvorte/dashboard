	...
	<body>
		...
		<div id="dash-main">
			...
			<div class="dash-narrow-content">
				<h2 class="dash-heading animate-box" data-animate-effect="fadeInLeft">Edit Subcategories</h2>
           ...
           <!-- card area -->
            ...
            ?>
                ...
                <div class="row g-0">
                    <div class="col-md-4">
                    <img style="max-height:130px;" src="images-db/item/<?php echo $image;?>"  class="img-fluid rounded-start" alt="...">
                    <a href="edit_subcategory.php?itemId=<?php echo $id;?>&image=<?php echo $image;?>"><h6 class="btn btn-primary animate-box" id="dlt-sub-btn">Edit Subcategory </h6></a>
