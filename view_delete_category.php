	...
	<div class="welcome">
		...
		<div id="dash-main">
			...
			<div class="dash-narrow-content">
				...
				<h2 class="dash-heading animate-box" data-animate-effect="fadeInLeft">Delete Category</h2>
				...
				<div class="card  animate-box" id="categ-card">
					...
					<form class="modal-content" action="/action_page.php">
						...
						<div class="clearfix">
							...
							<a href="delete_category.php?itemId=<?php echo $id;?>&image=<?php echo $image;?>" class="btn btn-warning">Delete</a>
						</div>
						</div>
					</form>
					</div>
