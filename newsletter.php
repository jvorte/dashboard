	...
	<body>
		...
		<div id="dash-main">
			...
			<div class="dash-narrow-content">
				<h2 class="dash-heading animate-box" data-animate-effect="fadeInLeft">Newsletters</h2>
				<div class="row">
			...
			<div class="dash-narrow-content">
                <div class="animate-box" style="border: 1px solid; border-radius: 7px;  box-shadow: 5px 10px 18px #888888;" class="container-sm ">
