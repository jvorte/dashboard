...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
        ...
        if (isset($_GET['itemId']))
        {
                    ...
                    $sql2 = "SELECT * FROM item_category WHERE itemId=$id";    
        ...
        ?>	
				...
				<div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="inputAddress" value="<?php echo $name;?>" name="subgroup" readonly>
				</div>
				<div class="col-12">
